		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist products",
									"targetURL": "#uxfreestylereport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxfreestylereport-display": {
								"semanticObject": "uxfreestylereport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.freestylereport",
									"url": sap.ui.require.toUrl("ux/freestylereport")
								}
							}
						}
					}
